...
export const Conclusion = () => {
    ...
    return <BoxedDiv>
        <TextDiv>
            ...
            <ul>
                <li><CodeSpan>useRef()</CodeSpan>:
                    When changing the variable should not cause a rerender. In other words: when the variable itself,
                    or dependents of it are not visible in the screen.
                </li>
                ...
                <li><CodeSpan>useContext()</CodeSpan>:
                    Useful to pass state to deeper context. Ideal when state is not often modified, and mostly
                    read.<br/>
                ...
                <li><CodeSpan>mobx state tree</CodeSpan>:
                    ...
                    part of the general application "state". MST also provides help with validating the types, making
                    sure
                    the when data is sent it has broadly the right structure.
                </li>
                <li><CodeSpan>useLocalObservable()</CodeSpan>:
                    Whenever state becomes complex, yet we only need it locally in a component, or it's near direct
                    children.<br/>
